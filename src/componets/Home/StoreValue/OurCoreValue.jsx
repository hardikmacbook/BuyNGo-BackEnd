...
// ParticleCard component (same as before - no changes)
const ParticleCard = ({
  children,
  className = '',
  ...
  // ... (keep all the existing ParticleCard code exactly as is)
...
// GlobalSpotlight component (same as before)
...
const MagicBento = ({
  ...
  // ✅ DATABASE SE DATA FETCH KARNE KE LIYE YE ADD KARO
